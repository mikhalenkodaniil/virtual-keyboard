...
var as='<form class="str-set"><label>Чтобы изменить язык нажмите:<button id="change-lang">Сменить язык</button><br><p>Желтые клавиши принудительно отключены, т.к. работают не корректно.</p></label><input type="text" id="print-text" value="Ваш текст"></form><div class="all-keyboard"><div id="keyboard"></div></div>';
